...
def getWeeklyStockTabSummary(theFilePath, theSymbol):
    ...
    earningsDayOpen_np = excelPastEarningsDateDF.Open.values
    earningsEDFwd1DayOpen_np = excelPastEarningsDateDF.EDFwd1DayOpen.values
    earnings4DayMove_np = excelPastEarningsDateDF.EDFwd4DayClosePercentDelta.values


    # Get Open/Close data
    earningsDayEPS =  excelPastEarningsDateDF[['Earnings_Date','EDClose','EDFwd1DayOpen', 'EDFwd1DayClose',
                                               'EDBak1DayOpen', 'EDBak1DayClose']]
    ...
    returnList = [earningsMdate_np, earningsDayOpen_np, earningsEDFwd1DayOpen_np]
